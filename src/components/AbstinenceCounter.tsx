...
export function AbstinenceCounter({ startDate }: CounterProps) {
  ...
  return (
    <div className="rounded-3xl p-8 md:p-12 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20">
      <p className="text-foreground/80 text-base mb-8">I've been abstinent for</p>
      <div className="grid grid-cols-3 gap-6 md:gap-8">
        <div className="text-center">
          <div className="text-7xl md:text-8xl font-bold text-primary mb-3 tracking-tight">{count.years}</div>
          <div className="text-xs uppercase tracking-widest text-muted-foreground font-semibold">Years</div>
        </div>
        <div className="text-center">
          <div className="text-7xl md:text-8xl font-bold text-primary mb-3 tracking-tight">{count.months}</div>
          <div className="text-xs uppercase tracking-widest text-muted-foreground font-semibold">Months</div>
        </div>
        <div className="text-center">
          <div className="text-7xl md:text-8xl font-bold text-primary mb-3 tracking-tight">{count.days}</div>
