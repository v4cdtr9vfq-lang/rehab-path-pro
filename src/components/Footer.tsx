...
export function Footer() {
  return (
    <footer className="mt-auto border-t border-border bg-card/50 backdrop-blur">
      <div className="mx-auto px-[15px] lg:px-8 max-w-6xl pt-12 pb-7">
        ...
        {/* Bottom Section */}
        <div className="mt-[46px] pt-[35px] pb-2 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
