            ...
            <div className="p-4 rounded-xl bg-muted/50 border border-sidebar-border">
              <div className="flex items-center gap-2">
                ...
                <select 
                  ...
                  className="bg-background border border-sidebar-border rounded-lg px-3 py-2 pr-8 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-primary appearance-none bg-no-repeat -ml-[5px]"
                  style={{
