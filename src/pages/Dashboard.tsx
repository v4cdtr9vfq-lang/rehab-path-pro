              ...
              return (
                <Card key={medal.type} className="border-border/50 h-full">
                  <CardContent className="p-4 md:p-6 flex items-center gap-3 md:gap-4">
                    <div className={`w-16 md:w-20 h-16 md:h-20 rounded-2xl bg-orange-500/40 flex items-center justify-center flex-shrink-0 ${status.opacity} transition-opacity duration-300`}>
