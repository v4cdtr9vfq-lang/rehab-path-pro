  ...
  },
  {
    ...
    secondaryEmotions: [
      ...
      },
      {
        id: "impaciente",
        name: "Impaciente",
        tertiaryEmotions: ["Agobiado", "Desesperado", "Intolerante", "Expectante"]
      },
      {
        id: "vulnerable",
        name: "Vulnerable",
  ...
  },
  {
    ...
    secondaryEmotions: [
      ...
      },
      {
        id: "desanimado",
        name: "Desanimado",
        tertiaryEmotions: ["Pereza", "Decepción", "Abatimiento"]
      },
      {
        id: "agotado",
        name: "Agotado",
              ...
              {emotionCategories.map((category) => {
                ...
                return (
                  <Button
                    ...
                    className={`rounded-full px-6 h-12 text-xl lg:text-base font-medium transition-all ${
                      isSelected
                        ...
                        {category.secondaryEmotions.map((emotion) => {
                          ...
                          return (
                            <Button
                              ...
                              className={`rounded-full px-6 h-12 text-xl lg:text-base font-medium transition-all flex-shrink-0 ${
                                isSelected 
                                  ? "bg-green-600 hover:bg-green-700 text-white border-green-600"
                                  : "hover:bg-primary/10 hover:border-primary/50"
                              }`}
