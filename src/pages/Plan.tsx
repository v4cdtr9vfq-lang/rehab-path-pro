  ...
  return <div className="space-y-[30px] animate-in fade-in duration-500 mt-[14px] md:-mt-[4px]">
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        ...
        <DialogHeader>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="edit-goal-text" className="block px-0">{t('plan.goalText')}:</Label>
            ...
            {editingGoal?.goal_type === 'periodic' && <div className="space-y-2">
                <Label htmlFor="edit-periodic-type" className="block px-0">{t('plan.periodicity')}:</Label>
            ...
            {editingGoal?.goal_type === 'onetime' && <div className="space-y-2">
                <Label className="block px-0">{t('plan.targetDate')}:</Label>
                <Popover>
                  <PopoverTrigger asChild>
            ...
            {editingGoal?.goal_type !== 'onetime' && <div className="space-y-2">
              <Label htmlFor="edit-goal-remaining" className="block px-0">{t('plan.numberOfTimes')}:</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-goal-instructions" className="block px-0">{t('plan.instructions')}:</Label>
              <Textarea 
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-goal-notes" className="block px-0">{t('plan.notes')}:</Label>
              <Textarea 
                id="edit-goal-notes" 
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-goal-link" className="block px-0">{t('plan.linkOptional')}:</Label>
              <Input 
                id="edit-goal-link" 
                type="url"
                placeholder="https://..." 
              ...
              />
              <p className="text-xs text-muted-foreground px-0">{t('plan.linkHint')}:</p>
            </div>
