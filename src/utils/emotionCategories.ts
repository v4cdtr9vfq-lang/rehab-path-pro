      ...
      },
      {
        ...
        secondaryEmotions: [
          ...
          },
          {
            id: "incomodo",
            name: "Uncomfortable",
            tertiaryEmotions: ["Uneasy", "Hurt", "Disgusted", "Violent"].sort()
          }
        ].sort((a, b) => a.name.localeCompare(b.name))
      },
      {
      ...
      },
      {
        ...
        secondaryEmotions: [
          ...
          },
          {
            id: "desanimado",
            name: "Discouraged",
            tertiaryEmotions: ["Defeated", "Demoralized", "Disheartened", "Disillusioned"].sort()
          },
          {
            id: "solo",
            name: "Lonely",
      ...
      },
      {
        ...
        secondaryEmotions: [
          ...
          },
          {
            id: "seguro",
            name: "Connected",
            tertiaryEmotions: ["Acceptance", "Belonging", "Happy", "Intimacy", "Predictability", "Trust", "Vulnerable"].sort()
          },
          {
            id: "empoderado",
            name: "Empowered",
      ...
      },
      {
        ...
        secondaryEmotions: [
          ...
          },
          {
            id: "comfortable",
            name: "Comfortable",
            tertiaryEmotions: ["Relaxed", "Safe", "Connected"].sort()
          },
          {
            id: "centered",
            name: "Centered",
            tertiaryEmotions: ["Aligned", "Focused", "Convinced"].sort()
          },
          {
            id: "content",
            name: "Content",
          ...
          },
          {
            id: "equanimous",
            name: "Equanimous",
            tertiaryEmotions: ["Connected"].sort()
          },
          {
            id: "fulfilled",
            name: "Fulfilled",
            tertiaryEmotions: ["Complete"].sort()
          },
          {
            id: "mellow",
            name: "Mellow",
          ...
          },
          {
            id: "serene",
            name: "Serene",
            tertiaryEmotions: ["Calm", "Connected"].sort()
          },
          {
            id: "trusting",
            name: "Trusting",
            tertiaryEmotions: ["Hope", "Tranquility", "Safety"].sort()
          }
        ].sort((a, b) => a.name.localeCompare(b.name))
      }
    ].sort((a, b) => a.name.localeCompare(b.name));
    ...
    },
    {
      ...
      secondaryEmotions: [
        ...
        },
        {
          id: "seguro",
          name: "Conectado",
          tertiaryEmotions: ["Aceptación", "Confianza", "Feliz", "Intimidad", "Pertenencia", "Previsibilidad", "Vulnerable"].sort()
        },
        {
          id: "empoderado",
          name: "Empoderado",
    ...
    },
    {
      ...
      secondaryEmotions: [
        ...
        },
        {
          id: "desanimado",
          name: "Desanimado",
          tertiaryEmotions: ["Derrotado", "Descorazonado", "Desilusionado", "Desmoralizado"].sort()
        },
        {
          id: "solo",
          name: "Solo",
          tertiaryEmotions: ["Aislado", "Indeseado", "Separado"].sort()
        }
      ].sort((a, b) => a.name.localeCompare(b.name, 'es'))
    },
    {
      ...
      secondaryEmotions: [
        ...
        },
        {
          id: "clearHeaded",
          name: "Claridad",
          tertiaryEmotions: ["Sereno", "Calmado", "Lúcido", "Enfocado"].sort()
        },
        {
          id: "comfortable",
          name: "Cómodo",
          tertiaryEmotions: ["Relajado", "Seguro", "Conectado"].sort()
        },
        {
          id: "centered",
          name: "Centrado",
          tertiaryEmotions: ["Alineado", "Enfocado", "Convencido"].sort()
        },
        {
          id: "content",
          name: "Conforme",
        ...
        },
        {
          id: "equanimous",
          name: "Ecuánime",
          tertiaryEmotions: ["Conectado"].sort()
        },
        {
          id: "fulfilled",
          name: "Realizado",
          tertiaryEmotions: ["Completo"].sort()
        },
        {
          id: "mellow",
          name: "Apacible",
        ...
        },
        {
          id: "serene",
          name: "Sereno",
          tertiaryEmotions: ["Calmado", "Conectado"].sort()
        },
        {
          id: "trusting",
          name: "Confianza",
          tertiaryEmotions: ["Esperanza", "Tranquilidad", "Seguridad"].sort()
        }
      ].sort((a, b) => a.name.localeCompare(b.name, 'es'))
    }
  ].sort((a, b) => a.name.localeCompare(b.name, 'es'));
