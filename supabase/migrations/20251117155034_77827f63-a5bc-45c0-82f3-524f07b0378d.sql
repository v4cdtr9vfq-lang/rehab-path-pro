-- Update the handle_new_user function to include all 7 goals with complete information
...
BEGIN
  ...
  -- Insert default goals in SPANISH with complete information (7 goals)
  ...
  -- Insert default goals in ENGLISH with complete information (7 goals)
  INSERT INTO public.goals (user_id, text, goal_type, periodic_type, remaining, completed, order_index, description, instructions, notes, link, language) VALUES
    ...
    (NEW.id, 'Review progress 📊', 'periodic', 'weekly', 1, false, 13, 'Review your weekly progress and adjust your goals.', 'Each week, take a moment to review what you have achieved and what you can improve.', 'Regular reflection helps you stay on track and adjust your strategy when necessary.', NULL, 'en');
  ...
  INSERT INTO public.values (user_id, name, value_type, order_index, language) VALUES
    (NEW.id, 'Self-care', 'primary', 9, 'en'),
    (NEW.id, 'Gratitude', 'primary', 10, 'en'),
    (NEW.id, 'Humor', 'primary', 11, 'en'),
    (NEW.id, 'Respect', 'secondary', 12, 'en'),
    (NEW.id, 'Health', 'secondary', 13, 'en'),
    (NEW.id, 'Consideration', 'secondary', 14, 'en'),
    (NEW.id, 'Commitment', 'secondary', 15, 'en'),
    (NEW.id, 'Honesty', 'secondary', 16, 'en'),
    (NEW.id, 'Responsibility', 'secondary', 17, 'en');
