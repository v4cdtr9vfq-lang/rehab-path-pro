-- Update the handle_new_user function to include 6 secondary values instead of 4
...
BEGIN
  ...
  -- Insert default values in SPANISH (3 primary + 6 secondary = 9 total)
  ...
  -- Insert default values in ENGLISH (3 primary + 6 secondary = 9 total)
  INSERT INTO public.values (user_id, name, value_type, order_index, language) VALUES
