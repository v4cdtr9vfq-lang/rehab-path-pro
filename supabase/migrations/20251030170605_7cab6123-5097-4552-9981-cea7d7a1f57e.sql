-- Update handle_new_user function to include complete goal information
...
BEGIN
  ...
  -- Insert default goals in SPANISH with complete information
  ...
  -- Insert default goals in ENGLISH with complete information
  INSERT INTO public.goals (user_id, text, goal_type, periodic_type, remaining, completed, order_index, description, instructions, notes, link, language) VALUES
...
-- Update reset_goals_and_abstinence function to include complete goal information
...
BEGIN
  ...
  -- Insert default goals in SPANISH with complete information
  INSERT INTO public.goals (user_id, text, goal_type, periodic_type, remaining, completed, order_index, description, instructions, notes, link, language) VALUES
    (p_user_id, '🛌 Hacer la cama', 'always', NULL, 1, false, 0, 'Una cama hecha es un recordatorio visual de tu compromiso con una vida ordenada y productiva.', 'Hacer la cama por la mañana es el primer paso de tu plan. Crea una inercia positiva para seguir el plan que has definido para tu transformación.', 'Este simple acto puede marcar el tono para el resto de tu día, dándote una sensación de logro desde el principio.', NULL, 'es'),
    (p_user_id, 'Meditación 🧘', 'always', 'daily', 1, false, 1, 'Dedica tiempo cada día a meditar y visualizar tus metas.', 'Encuentra un lugar tranquilo, cierra los ojos y respira profundamente. Visualiza tu vida libre de adicciones.', 'La práctica regular de meditación y visualización fortalece tu mente y te ayuda a mantenerte enfocado en tu recuperación.', NULL, 'es'),
    (p_user_id, 'Diario emocional 🌞', 'always', NULL, 1, false, 2, 'Escribe sobre tus emociones para comprenderlas mejor.', 'Toma unos minutos para reflexionar sobre cómo te sientes hoy y escribe tus pensamientos.', 'Escribir sobre tus emociones te ayuda a procesarlas y encontrar patrones en tu comportamiento emocional.', 'https://rehabp.org/emotion-journal', 'es'),
    (p_user_id, 'Inventario diario 🤔', 'always', 'daily', 1, false, 3, 'Haz un inventario personal diario para evaluar tu progreso.', 'Al final del día, reflexiona sobre tus acciones, decisiones y emociones.', 'El inventario diario te permite identificar áreas de mejora y celebrar tus logros.', 'https://rehabp.org/journal?title=Inventario diario', 'es'),
    (p_user_id, 'Carta de agradecimiento 💌', 'periodic', 'final_mes', 1, false, 4, 'Escribe una carta de agradecimiento a alguien que te ha apoyado.', 'Piensa en alguien que ha sido importante en tu vida y escribe una carta expresando tu gratitud.', 'Expresar gratitud fortalece tus relaciones y te ayuda a reconocer las cosas positivas en tu vida.', 'https://rehabp.org/journal?title=Carta de agradecimiento', 'es'),
    (p_user_id, 'Contactar a un amigo 📞', 'periodic', 'mitad_mes', 1, false, 5, 'Mantén el contacto con tus amigos y seres queridos.', 'Llama o envía un mensaje a un amigo para ponerte al día.', 'Las conexiones sociales son fundamentales para tu bienestar emocional y tu proceso de recuperación.', NULL, 'es');
  ...
  INSERT INTO public.goals (user_id, text, goal_type, periodic_type, remaining, completed, order_index, description, instructions, notes, link, language) VALUES
    ...
    (p_user_id, 'Emotional Journal 🌞', 'always', NULL, 1, false, 8, 'Write about your emotions to understand them better.', 'Take a few minutes to reflect on how you feel today and write down your thoughts.', 'Writing about your emotions helps you process them and find patterns in your emotional behavior.', 'https://rehabp.org/emotion-journal', 'en'),
    (p_user_id, 'Daily inventory 🤔', 'always', 'daily', 1, false, 9, 'Do a daily personal inventory to assess your progress.', 'At the end of the day, reflect on your actions, decisions and emotions.', 'The daily inventory allows you to identify areas for improvement and celebrate your achievements.', 'https://rehabp.org/journal?title=Daily inventory', 'en'),
